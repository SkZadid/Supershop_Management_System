...
<p align="center">
  <b>A C# Windows Forms application for real-life super shop operations</b><br>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Database-SQL%20Server-CC2927?style=flat-square&logo=microsoft-sql-server&logoColor=white" />
...
| Role        | Capabilities                                                                 |
|-------------|-------------------------------------------------------------------------------|
| 👨‍💼 Manager  | 🔹 Add/Remove Managers & Employees<br>🔹 Edit Profile<br>🔹 Manage Products<br>🔹 View Sales History |
| 👷‍♂️ Employee | 🔹 Update Profile<br>🔹 Manage Products<br>🔹 Generate Customer Bills               |
...
### 🧑‍💼 Manager Dashboard
![Manager Dashboard](screenshots/manager_dashboard_profile.jpg)
![Manager Dashboard](screenshots/manage_employee.png)

---

### 📦 Product Management Panel
![Product Panel](screenshots/product_add.png)

---

### 🧾 Customer Billing
![Billing Panel](screenshots/billing.jpg)
![Billing Panel](screenshots/Sells_record.jpg)
